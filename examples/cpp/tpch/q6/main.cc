...
static const int SHIPDATE_IDX = 10;
static const int DISCOUNT_IDX = 6;
static const int QUANTITY_IDX = 4;
static const int EXTENDED_PRICE_IDX = 5;
...
int main(int argc, char** argv) {
    ...
    cout << fixed << "framework,load,compile,query,total\n"
         << "weld," << load_time << "," << compile_time << "," << query_time << ","
         << load_time + compile_time + query_time << endl;
    return 0;
}